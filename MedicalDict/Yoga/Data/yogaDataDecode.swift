...
//
//
//func loadYogaJSONData() -> [yogaData] {
//    guard let url = Bundle.main.url(forResource: "yoga", withExtension: "json") else {
...
//    
//    do{
//        return try decoder.decode([yogaData].self, from: data)
