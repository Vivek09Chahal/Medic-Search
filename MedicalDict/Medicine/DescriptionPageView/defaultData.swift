...
//  MedicalDict
//
//  Created by Vivek Chahal on 4/4/25.
//
...
extension PreviewProvider {
    ...
    static var dev: medicinePreview {
        return medicinePreview.instance
    }
    
}

class medicinePreview: ObservableObject {
    
    static let instance = medicinePreview()
    
    let MedicinePreview: Medicine = Medicine(/*Done*/medicineName: "Paracetamol",
